...
- **Bounds what it can cost.** Refuses within 10 minutes of the last refresh,
  refuses while one is running, and refuses past **10 a day** or **30 in 30
  ...
  day. To change the limits, edit the two constants at the top of the worker
  and redeploy; the test suite reads them from there.
  Sizing: Apify's free $5/month covers roughly 27 refreshes at $0.18 each, and
  the Claude side is about $0.47 each — so 30 a month is near the point where
  both bills matter.
...
| *N refreshes in the last 24 hours / 30 days; the limit is M* | The daily or monthly cap — raise the constants in the worker if the budget allows |
